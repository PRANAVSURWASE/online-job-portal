...
const CTASection = () => {
  ...
  return (
    <section className="py-4  text-white" style={{ background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' }}>
      <Container>
        {/* Two-column CTA */}
        <Row className="mb-5">
          ...
          <Col lg={6}>
            <Card className="bg-white text-dark h-100 border-0 shadow">
              <Card.Body className="p-4 text-center">
                ...
                <Card.Text className="mb-4">
                  Post jobs and connect with qualified candidates. Use our
                  advanced tools to find the perfect fit for your team.
                </Card.Text>
                <Button
                  variant="success"
                  className="d-flex align-items-center justify-content-center mx-auto"
          ...
          <Col lg={8} className="mx-auto text-center">
            ...
            <div className="d-flex gap-3 justify-content-center flex-wrap">
              <Button
                ...
                size="lg"
                className="px-4"
                onClick={() => navigate("/jobseeker-register")} // or "/employer-register"
              >
                Sign Up Now
              </Button>
