              ...
              <div>
                ...
                {loadingJobs ? (
                  ...
                  <ul className="list-group">
                    {jobs
                      .filter((job) =>
                        [job.j_name, job.location, job.skills]
                          .join(" ")
                          .toLowerCase()
                      ...
                      .map((job) => (
                        <li key={job.j_id} className="list-group-item">
                          ...
                          <button
                            ...
                            onClick={() => handleApplyJob(job.j_id, job.hr_id)}
                  ...
                  <ul className="list-group">
                    {interviews.map((intv, index) => (
                      <li key={index} className="list-group-item">
                        <h5>
                          <strong>Job:</strong> {intv.jobTitle}
                        </h5>
                        <p>
                          <strong>Company:</strong> {intv.companyname}
                        </p>
                        <p>
                          <strong>HR:</strong> {intv.hrName}
                        </p>
                        ...
                        <p>
                          <strong>Time:</strong> {intv.time}
                        </p>
                        <p>
                          <strong>location:</strong> {intv.location}
                        </p>
                        <p>
                          <strong>Mode:</strong> {intv.mode}
                        </p>
                        {intv.mode === "ONLINE" && (
                        ...
                        <p>
                          <strong>Notes:</strong> {intv.notes}
                        </p>
                      </li>
                    ))}
                  </ul>
